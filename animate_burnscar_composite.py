...
n=3
# print(geo_file_timestamps[0], geo_filepaths[0],cldmsk_file_timestamps[0])
geo_file    = [x for x, y in zip(geo_filepaths, geo_file_timestamps) if ('2022121' in y or '2022127' in y)][n]
# print(geo_file)
# sys.exit()
ref_file    = [x for x, y in zip(ref_filepaths, geo_file_timestamps) if ('2022121' in y or '2022127' in y)][n]
which_bands = [3,4,5,7,11] # [blue, green, red, veggie, burn]
cldmsk_file = [x for x, y in zip(cldmsk_filepaths, geo_file_timestamps) if ('2022121' in y or '2022127' in y)][n]
