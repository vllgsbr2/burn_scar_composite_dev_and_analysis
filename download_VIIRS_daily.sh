...
do
  ...
  do
    VJ109_file_str="VJ109_NRT.A$year$day_of_year.$hour$min.002.hdf"
    path_to_viirs_VJ109="$URL_source/5200/VJ109_NRT/$year/$day_of_year/$VJ109_file_str"
...
do
  for min in "${valid_min_list[@]}"
  do
    VJ103_file_str="VJ103MOD_NRT.A$year$day_of_year.$hour$min.021.nc"
    path_to_viirs_VJ103="$URL_source/5201/VJ103MOD_NRT/$year/$day_of_year/$VJ103_file_str"
